...
public class Col1_Ej15 {
	public static void main(String[] args) {
		...
		double minutos = segundos / 60.0;     //convertimos a minutos dividiendo entre 60
		System.out.format("Minuto(s): %.1f%n", minutos);
		double horas = segundos / 3600.0;	//convertimos a horas dividiendo entre 3600
		System.out.format("Hora(s): %.2f%n", horas);
		double dias = segundos / 86400.0;
